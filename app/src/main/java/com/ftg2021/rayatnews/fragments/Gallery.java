...
import com.ftg2021.rayatnews.Adapter.CategoryAdapter;
import com.ftg2021.rayatnews.Adapter.CategoryFragmentAdapter;
import com.ftg2021.rayatnews.Adapter.GalleryFragmentAdapter;
...
public class Gallery extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root= inflater.inflate(R.layout.fragment_gallery_view_new, container, false);
    ...
    private void fetchCategories()
    {
        ...
        try {
            ...
            String URL = AccessData.getApiUrl()+"listGallery";
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    try
                    {
                        ...
                        List<NewsGalleryModel> categoryList=new ArrayList<>();
                        ...
                        for(int i=0;i<jsonArray.length();i++)
                        {
                            ...
                            String galleryId = object.getString("galleryId");
                            String galleryName = object.getString("galleryName");
                            String galleryImage = object.getString("galleryImage");
                            String gi1= object.getString("gi1");
                            String gi2= object.getString("gi2");
                            String gi3= object.getString("gi3");
                            String gi4= object.getString("gi4");
                            String gi5= object.getString("gi5");
                            String gi6= object.getString("gi6");
                            String gi7= object.getString("gi7");
                            String gi8= object.getString("gi8");
                            String gi9= object.getString("gi9");
                            String gi10= object.getString("gi10");
                            String gi11= object.getString("gi11");
                            String gi12= object.getString("gi12");
                            String gi13= object.getString("gi13");
                            String gi14= object.getString("gi14");
                            String gi15= object.getString("gi15");

                            categoryList.add(new NewsGalleryModel(galleryId,galleryName,galleryImage,gi1,gi2,gi3,gi4,gi5,gi6,gi7,gi8,gi9,gi10,gi11,gi12,gi13,gi14,gi15));
                        ...
                        GalleryFragmentAdapter adapter = new GalleryFragmentAdapter(getContext(), categoryList);
...
//                            newsList.add(new NewsDataModel(""+newsId,heading,description,imageUrl,date,sourceName));
                            ...
                            if(i%5==0 && i>0)
                                newsList.add(new NewsDataModel(0,"","","","","","","",true,0));
